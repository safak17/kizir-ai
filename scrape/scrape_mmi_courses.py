...
filepath_content = os.path.join(DATA_PATH, "mmi_courses.txt")
filepath_titles = os.path.join(DATA_PATH, "mmi_titles.txt")


url = "https://ii.metu.edu.tr/multimedia-informatics-msphd"
