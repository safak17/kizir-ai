...
filepath_content = os.path.join(DATA_PATH, "sm_courses.txt")
filepath_titles = os.path.join(DATA_PATH, "sm_titles.txt")


url = "https://ii.metu.edu.tr/software-management-ms"
