...
filepath_content = os.path.join(DATA_PATH, "cogs_courses.txt")
filepath_titles = os.path.join(DATA_PATH, "cogs_titles.txt")


url = "https://cogs.metu.edu.tr/en/programs"
...
if response.status_code == 200:
    ...
    div_content = soup.find('div', class_='field-name-body')
