...
# http://oidb.metu.edu.tr/en/middle-east-technical-university-rules-and-regulations-governing-graduate-studies
...
url = 'http://oidb.metu.edu.tr/en/middle-east-technical-university-rules-and-regulations-governing-graduate-studies'
...
# Write to file
title_path = os.path.join(DATA_PATH, "titles_gradute.txt")
...
# Write to file
paragraph_path = os.path.join(DATA_PATH, "paragraphs_graduate.txt")
